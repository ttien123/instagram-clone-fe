const IconEmoji = ({ height = 20, width = 20 }: { height?: number; width?: number }) => {
    return (
        <svg aria-label="Emoji" fill="currentColor" height={height} role="img" viewBox="0 0 24 24" width={width}>
            <title>Emoji</title>
